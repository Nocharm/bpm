...
const en = {
  ...
  "editor.viewerNotice": "Viewing with viewer access — clone to your maps to edit.",
  "editor.cloneToMine": "Clone to my maps",
  "err.copyMap": "Failed to clone map",
...
const ko: Record<MessageKey, string> = {
  ...
  "editor.watermark": "READ ONLY",
  "editor.viewerNotice": "뷰어 권한으로 열람 중입니다. 편집하려면 내 맵으로 복제 후 진행하세요.",
  "editor.cloneToMine": "내 맵으로 복제",
  "err.copyMap": "맵 복제에 실패했습니다",
