...
const en = {
  ...
  "edge.outputSwapped": "Each node has one output — replaced the previous connection. Use a Decision node to branch.",
...
const ko: Record<MessageKey, string> = {
  ...
  "edge.outputSwapped": "노드 출력은 1개입니다 — 기존 연결을 교체했습니다. 분기가 필요하면 Decision 노드를 사용하세요.",
  "ctx.align": "정렬 · 레이아웃",
