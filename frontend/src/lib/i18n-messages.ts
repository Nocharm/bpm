...
const en = {
  ...
  "perm.deleteConfirmBody": "Remove this map from the mock store? The real map on the backend is unaffected.",
...
const ko: Record<MessageKey, string> = {
  ...
  "perm.deleteConfirmBody": "mock 스토어에서 이 맵을 제거합니까? 백엔드의 실제 맵은 유지됩니다.",
