    ...
    const map1: Graph = {
      ...
      subprocess_refs: {
        2: {
          ...
          duration: "2.15", cost_krw: "500000", cost_usd: null, headcount: "3", touch_time: null, input: null, output: null, input_forms: null, output_forms: null, start_condition: null, end_condition: null, frequency_fallback: null, gmp: null, url: null, url_label: null,
          sp_description: null,
        },
      },
    };
  ...
  it("서브프로세스 행 description은 링크 맵 sp_description(베이스)+줄바꿈+노드 추가분으로 합성된다", async () => {
    const map1: Graph = {
      ...
      subprocess_refs: {
        2: {
          name: null, designated: true, department: null, assignee: null, system: null,
          duration: null, cost_krw: null, cost_usd: null, headcount: null, touch_time: null, input: null, output: null, input_forms: null, output_forms: null, start_condition: null, end_condition: null, frequency_fallback: null, gmp: null, url: null, url_label: null,
