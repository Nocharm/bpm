  ...
  return (
    <section data-id="home-my-documents" className="flex flex-col gap-3 rounded-sm border border-hairline bg-surface-alt p-3">
      ...
      <div className="flex items-center gap-3">
        <Donut segments={segments} size={104} selectedKey={selected} onSelect={(k) => setSelected(k as VersionStatus)} label={t("home.myDocuments")} centerCaption={t("home.donutTotal")} />
