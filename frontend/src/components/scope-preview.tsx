...
export function ScopePreview({
  ...
  if (scopeNodes.length === 0) {
    return <div className={`h-full w-full ${charcoal ? "rounded-md border-2 border-accent/70 bg-canvas-l5" : "bg-canvas"}`} />;
  }
  ...
  return (
    <div
      ...
      className={`${interactive || pannable ? "pointer-events-auto" : "pointer-events-none"} h-full w-full ${charcoal ? "overflow-hidden rounded-md border-2 border-accent/70 bg-canvas-l5" : "bg-canvas"} ${
