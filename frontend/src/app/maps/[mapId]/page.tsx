...
function MapEditor({ mapId }: { mapId: number }) {
  ...
  return (
    <NodeActionsContext.Provider value={nodeActions}>
      ...
      <style>{`.bpm-expand-anim .react-flow__node{transition:transform 350ms cubic-bezier(0.65,0,0.35,1)}@media(prefers-reduced-motion:reduce){.bpm-expand-anim .react-flow__node{transition:none}}@keyframes bpm-node-flash{0%{opacity:1}45%{opacity:.25}100%{opacity:1}}.react-flow__node.bpm-node-flash{animation:bpm-node-flash 450ms ease-in-out}@media(prefers-reduced-motion:reduce){.react-flow__node.bpm-node-flash{animation:none}}.react-flow__handle{width:13px;height:13px;border-radius:3px;background:color-mix(in srgb,var(--color-accent) 18%,transparent);border:1px solid color-mix(in srgb,var(--color-accent) 40%,transparent);opacity:0;transition:opacity 120ms var(--ease-smooth),background 120ms var(--ease-smooth),transform 120ms var(--ease-smooth)}.react-flow__node:hover .react-flow__handle{opacity:1}.react-flow__handle:hover{opacity:1;background:color-mix(in srgb,var(--color-accent) 38%,transparent);border-color:var(--color-accent);transform:scale(1.2)}@media(prefers-reduced-motion:reduce){.react-flow__handle:hover{transform:none}}`}</style>
