...
| A11 | 관리자 | **유저그룹 개선 4건**(Message 3): ①매니저=멤버 카드에서 토글(피커 삭제) ②멤버 박스=홈 상세 카드 재활용 ③**가시성 필터**(sysadmin 전체·일반 유저는 해당 그룹만) ④상단 SVG 안내 가이드(목적·신청/관리/사용). `groups-panel`·`group-detail`·`routers/groups` | ③ backend 325✅ | ③✅ | 🔧 ③ 가시성 완료, ①②④ 진행 | (S6) |
