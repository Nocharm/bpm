...
| B1 | 버그 | viewer가 허용 멤버 목록 못 봄 → **GET /permissions 게이팅 editor→viewer**(읽기만) | backend 316✅ | ✅ | 🔧 (a) 반영, 멤버 표시 복구 | `9bbfe06` |
| B2 | 버그 | 맵 설정 토스트 폭주 → showToast가 권한거부(403/401) 무음 + 뷰어 체크아웃 배지 `!isViewer` | ✅ | ✅ | 🔧 반영 | `9fb4701` |
| H1 | 홈 | 상태 필 필터(초안/검토중/승인됨/반려/게시), 가시성과 다중선택 | — | — | ⏳ | — |
| H2 | 홈 | 멤버-로우 2번째 줄 소속(org_path 전체) | — | — | ⏳ | — |
...
| H6 | 홈 | 1:2 컨테이너 max-width 1152→1280 | — | — | ⏳ | — |
