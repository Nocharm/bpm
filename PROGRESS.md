...
## 2026-08-25 — SP 최신본 추종 배너 (dev)
- 고정버전/업데이트 가능 배너와 같은 결로 "Following latest" 상시 배너 추가(RefreshCw·중립 톤). follow_latest는 전 노드 공통 불리언이라 실링크+지정 유효(undesignated 아님)로 게이트.
