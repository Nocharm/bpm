...
async def get_map(
    ...
    # 규칙은 can_decide_slot_for_map에 단일화 — approval-requests 목록 게이트(permissions.py)도 재사용.
    found_map.can_decide_slot = await can_decide_slot_for_map(session, user, found_map)
