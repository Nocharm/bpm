...
{"title": <보고 제목 한 줄. 예: "발주 프로세스 v3 변경 보고">,
 ...
 "sections": [{"heading": <개정 의도(명사형). 예: "출고 전 품질 통제 강화">, "points": [<그 의도를 이루는 변경 1~4개, 명사형 한 줄>], "refs": [<ref>...]}],
 "impacts": [{"point": <흐름·통제·부담 영향 한 줄(명사형)>, "refs": [<ref>...]}],
 "unmentioned": [{"point": <제출 코멘트에 언급되지 않은 실질 변경 한 줄>, "refs": [<ref>...]}],
