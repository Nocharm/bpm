...
- Filter chips narrow the list by **Status** (Draft / Pending / Approved / Rejected / Published), by your **Role**, by **Owning** (maps missing an owning department), and by **SP** (SP maps / non-SP maps). **Clear filters** resets them. On narrow screens the filter pills shrink automatically (full label → short label → icon).
...
*Business Process Map — Getting Around · Updated 2026-09-07*
