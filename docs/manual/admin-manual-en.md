...
The entry card above the interview import card (sysadmin only) fills an L5 through a conversation with AI instead of a document. Pick a level-5 category and press **Fill L5 with AI** to open a new campaign session.
