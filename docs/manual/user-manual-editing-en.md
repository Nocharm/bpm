...
- **Layout** — the left side is the **working-map preview** that draws itself as the interview progresses; the right side is the chat panel (drag the divider to resize). Click a node in the preview to mention it in chat (**Ask about this**).
