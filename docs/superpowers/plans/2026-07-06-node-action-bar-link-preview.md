...
- [x] **Step 2: NodeActionBar 컴포넌트 작성**
...
- [x] **Step 2: globals.css keyframes 추가**
...
- [x] **Step 3: LinkPreviewPanel 컴포넌트 작성**
...
- [x] **Step 1: page.tsx 그룹 모서리 버튼 + leaveGroup + selectedGroupIds 제거**
...
- [x] **Step 2: process-node.tsx ExpandToggleButton 제거**
...
- [x] **Step 4: 그룹 나가기 수동 검증** *(스크립트 자동화로 검증 — readOnly 그룹나가기 게이팅 서브체크는 수동 보류)*
...
- [x] **Step 5: 전체 검증 + 빌드** *(pw-smoke-demo는 구시드 전제라 스킵 — PROGRESS 기록)*
