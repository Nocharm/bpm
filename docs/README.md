...
- [`design/2026-09-12-assignee-role-next-session.md`](design/2026-09-12-assignee-role-next-session.md) — 역할·카탈로그 트랙 다음 세션 핸드오프(변경 요약 + 미룬 결정: AI 계약·CSV 임포트·컨설턴트 임포트 최신화).
