...
- [`design/2026-09-12-catalog-alias-node-swap-design.md`](design/2026-09-12-catalog-alias-node-swap-design.md) — 카탈로그 별칭(정식 표기 치환·CSV 2열·탭 편집) + 노드 담당자/시스템 줄 휴식↔활성 페이드 전환(1초 상수) + 노드 내 칩 흑백 (설계 승인, 구현 전).
