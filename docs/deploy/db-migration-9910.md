...
- [ ] **컨설턴트 체계**: 홈 Framework 토글 → 카테고리 트리 lazy 로드, 연결/이양 모달, SP 폼 I/O 필드(설계: [`2026-08-08-consultant-hierarchy-design.md`](../design/2026-08-08-consultant-hierarchy-design.md)).
