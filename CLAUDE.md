...
nginx/      # 리버스 프록시 설정
docs/       # 인덱스 docs/README.md · spec.md · lessons/(시행착오 방지) · superpowers/specs/(설계 기록)
docker-compose.yml
```
